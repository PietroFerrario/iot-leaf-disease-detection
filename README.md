...
- Portenta H7
    ...
    - portenta_deply/: Code deployed on the Portenta H7. portenta_2nn_wifi.py for the dual neural-network setup.

- Tensorflow/: Full neural network pipeline: model definition, training, pruning, quantization, and fine-tuning.

- IoT_Portenta: checkpoint for professor
